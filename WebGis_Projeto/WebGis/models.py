...
class TipoOcorrencia(models.Model):
    ...
    '''
    toc_usuario = models.ForeignKey(User, on_delete=models.CASCADE)
...
class Ocorrencia(models.Model):
    ...
    '''
    oco_usuario = models.ForeignKey(User, on_delete=models.CASCADE)
    oco_tipoOcorrencia = models.ForeignKey(TipoOcorrencia, on_delete=models.CASCADE)
...
class RegistroOcorrencia(models.Model):
    ...
    '''
    reg_Ocorrencia = models.ManyToManyField(Ocorrencia)
